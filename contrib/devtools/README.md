...
Setup
---------
Configuring the github-merge tool for the Airin repository is done in the following way:

    git config githubmerge.repository airin/airin
...
A script to optimize png files in the Airin
