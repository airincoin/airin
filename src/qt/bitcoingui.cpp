...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Airin Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Airin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Airin Core help message to get a list with possible Airin command-line options"));
