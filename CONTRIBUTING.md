...
The Airin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Airin Core project, and is not to be
confused with overall Airin Network Protocol consensus changes.

Whether a pull request is merged into Airin Core rests with the project merge
...
Patches that change Airin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Airin consensus, it must have been
