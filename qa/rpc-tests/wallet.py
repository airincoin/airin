...
#   c) node1 mines 32 blocks, so now node 0 has 500000AIRIN, node 1 has 4250AIRIN, node2 has none.
#   d) node0 sends 601 AIRIN to node2, in two transactions (301 AIRIN, then 300 AIRIN).
