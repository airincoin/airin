...
In order to support loading of multiple wallets in airin-qt, a few changes in the UI architecture will be needed.
...
----------------------
airin.cpp is the entry point into airin-qt, and as such, will require some minor modifications to provide hooks for
