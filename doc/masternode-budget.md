...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<airin_address\> \<monthly_payment_airin\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<airin_address\> \<monthly_payment_airin\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` AIRIN.
